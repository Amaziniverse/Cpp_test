...
//	ON_NOTIFY(LVN_ITEMCHANGED, IDC_LIST1, &CMExListCtrlDlgDlg::OnItemchangedList1)
	ON_CBN_SELCHANGE(IDC_COMBO1, &CMExListCtrlDlgDlg::OnCbnSelchangeCombo1)
	ON_NOTIFY(LVN_ITEMCHANGED, IDC_LIST1, &CMExListCtrlDlgDlg::OnItemchangedList1)
END_MESSAGE_MAP()
...
BOOL CMExListCtrlDlgDlg::OnInitDialog()			// 다이얼로그 초기화 함수 
{
	...
	m_largeImage->Create(32, 32, ILC_COLOR4, 3, 3);		// 사이즈용 배열 선언 
	...
	m_ListCtrl.SetImageList(m_largeImage, LVSIL_NORMAL);		// 이미지만 보이고 글자는 안 없는 상태
...
void CMExListCtrlDlgDlg::OnCbnSelchangeCombo1()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
